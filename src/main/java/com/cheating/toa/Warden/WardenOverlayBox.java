...
import com.cheating.toa.RaidRoom;
import com.cheating.toa.RaidStateTracker;
...
public class WardenOverlayBox extends RoomOverlay {
    ...
    @Inject
    protected WardenOverlayBox(CheatingConfig config, ModelOutlineRenderer outliner, Warden plugin) {
