...
public class OverlayPrayerBox extends Overlay
{
    ...
    @Inject
    OverlayPrayerBox(final Client client, final CheatingPlugin plugin, final CheatingConfig config, final SpriteManager spriteManager)
    {
        super(plugin);
    ...
    public Dimension render(final Graphics2D graphics)
    {
        ...
        infoBoxComponent.setBackgroundColor(client.isPrayerActive(prayer.getApiPrayer())
