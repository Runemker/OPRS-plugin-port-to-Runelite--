...
import com.cheating.inferno.displaymodes.InfernoNamingDisplayMode;
...
class InfernoWaveMappings
{
    ...
    static void addWaveComponent(CheatingConfig config, PanelComponent panelComponent, String header, int wave, Color titleColor, Color color)
    {
